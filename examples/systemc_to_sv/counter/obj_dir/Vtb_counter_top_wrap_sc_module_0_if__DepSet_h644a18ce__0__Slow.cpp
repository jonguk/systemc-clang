...
VL_ATTR_COLD void Vtb_counter_top_wrap_sc_module_0_if___ctor_var_reset(Vtb_counter_top_wrap_sc_module_0_if* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtb_counter_top_wrap_sc_module_0_if___ctor_var_reset\n"); );
