...
VL_ATTR_COLD void Vtb_counter2_counter_sc_module_1_if___ctor_var_reset(Vtb_counter2_counter_sc_module_1_if* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_counter2_counter_sc_module_1_if___ctor_var_reset\n"); );
