...
$SYSTEMC_CLANG_BUILD_DIR/systemc-clang $1 --top-module=$2 -- -std=c++17 -D__STDC_CONSTANT_MACROS -D__STDC_LIMIT_MACROS -I$LLVM_INSTALL_DIR/include -I$LLVM_INSTALL_DIR/lib/clang/15.0.7/include/ -I/usr/include -I$SYSTEMC/include -x c++ -w -c 
